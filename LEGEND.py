...
TELEGRAM_BOT_TOKEN = '7074559050:AAGxsg9SdeBxg8nNyvza2YrxfCLKEuCqaQY'
...
async def start(update: Update, context: CallbackContext):
    ...
    keyboard = [
        [InlineKeyboardButton("𝐌𝐀𝐒𝐒𝐀𝐆𝐄 𝐋𝐄𝐆𝐄𝐍𝐃", url=f"tg://user?id={ALLOWED_USER_ID}")],
    ]
